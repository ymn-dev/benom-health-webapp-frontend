...
import calisthenics from "../../assets/calisthenics.png";
...
const Calisthenics = () => {
  return <>
    <div className="flex justify-between bg-[#FF9671]">
      <p className="font-bold text-3xl p-5">CALISTHENICS</p>
    ...
    <div className=" flex ">
      ...
      <div>
        ...
        <div className="flex">
          <img src={Benom_Calisthenics_icon} alt="Benom_Calisthenics_icon" />
          <div>
            <img src={fire_icon} alt="fire_icon.png" />
            <details className="dropdown mb-2">
              <summary className="m-2 btn font-bold border-black ">CALISTHENICS</summary>
