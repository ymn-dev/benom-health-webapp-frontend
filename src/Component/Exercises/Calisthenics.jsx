...
const Calisthenics = () => {
  ...
  <div className=" relative">
    <img src={calisthenics} alt="calisthenics" className=" w-full"/>
    <div className=" absolute top-0 left-0 w-full h-full flex">
      ...
      <section className=" w-[50%] h-full bg-white bg-opacity-70 p-[5rem] flex flex-col gap-y-[1rem] ">
          ...
          <div className="flex">
              <img src={Benom_Calisthenics_icon} alt="Benom_Calisthenics_icon" className="mix-blend-darken w-[6.25rem] h-[7rem]"/>
              <div>
