...
import walking01 from "../../assets/walking01.png";
import Benom_Walking_icon from "../../assets/Benom_Walking_icon.png";
import fire_icon from "../../assets/3_fire_icon.png";

const Walking = () => {
  return  <>
  <div className=" relative">
    <img src={walking01} alt="walking" className=" w-full"/>
    <div className=" absolute top-0 left-0 w-full h-full flex">
      {/* Left */}
      <section className=" w-[50%] h-full bg-white bg-opacity-10">
        <p className="font-bold text-5xl text-white ml-10 mt-20">WALKING</p>
      </section>

      {/* Right */}
      <section className=" w-[50%] h-full bg-white bg-opacity-60 p-[5rem] flex flex-col gap-y-[1rem] ">
        
          <a href="/log-activity"><p className="font-bold text-3xl m-4">LOG ACTIVITY </p></a>
          <p className="font-bold  ml-4">COMMON ACTIVITY</p>
          <div className="flex">
              <img src={Benom_Walking_icon} alt="Benom_Walking_icon" className="mix-blend-darken w-[6.25rem] h-[6rem]"/>
              <div>
                  ...
                  <select className="select select-bordered border-gray-700 w-full max-w-xs mb-3">
                    ...
                    <option>SLOW WALK</option>
                    <option>RACE WALK</option>
                    <option>MARATHON WALK</option>
                  </select>
              </div> 
          </div>
            <div>
                ...
                <input className="rounded-lg mb-2 w-40"
                  ...
                  id="Weight"
                  name="Weight"
                  placeholder="Enter Weight in Kg หน้าวิ่ง"
                /><br />
