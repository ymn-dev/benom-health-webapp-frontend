...
const Running = () => {
  ...
  <div className="flex justify-between bg-[#FF9671]">
    <p className="font-bold text-3xl p-5">RUNNING</p>
  ...
  <div className=" flex ">
    ...
    <div>
      ...
      <div className="flex">
        <img src={Benom_Running_icon} alt="Benom_Running_icon" />
        <div>
          <img src={fire_icon} alt="fire_icon.png" />
          <details className="dropdown mb-2">
            <summary className="m-2 btn font-bold border-black">RUNNING</summary>
