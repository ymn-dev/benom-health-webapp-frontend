...
const Running = () => {
  ...
  const options = [];
  for (const choice in ExerciseChoices["Running"]) {
    options.push(ExerciseChoices["Running"][choice]);
  }
  return (
        ...
        <div className=" w-full">
          <div className="px-10 max-lg:px-0 ">
            <div className="flex  m-3">
              ...
              <img className="m-auto h-28 max-sm:hidden rounded-xl" src={benomIconRun} alt="" />
