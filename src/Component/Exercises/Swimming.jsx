...
const Swimming = () => {
  ...
  <div className="flex justify-between bg-[#FF9671]">
    <p className="font-bold text-3xl p-5">SWIMMING</p>
  ...
  <div className=" flex ">
    ...
    <div>
      ...
      <div className="flex">
        <img src={Benom_Swimming_icon} alt="Benom_Running_icon" />
        <div>
          <img src={fire_icon} alt="fire_icon.png" />
          <details className="dropdown mb-2">
            <summary className="m-2 btn font-bold border-black">SWIMMING</summary>
