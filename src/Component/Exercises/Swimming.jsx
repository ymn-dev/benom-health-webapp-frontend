      ...
      <section className=" w-[50%] h-full bg-white bg-opacity-10">
        <p className="font-bold text-5xl text-white ml-10 mt-20">SWIMMING</p>
          ...
          <section className=" w-[50%] h-full bg-white bg-opacity-70 p-[5rem] flex flex-col gap-y-[1rem] ">
            ...
            <div className="flex">
              <img src={Benom_Swimming_icon} alt="Benom_Swimming_icon" className="mix-blend-darken w-[6.25rem] h-[7rem]" />
      {/* Right */}
      <section className=" w-[50%] h-full bg-white bg-opacity-70 p-[5rem] flex flex-col gap-y-[1rem] ">
          ...
          <div className="flex">
            ...
            <div>
              ...
              <input className="rounded-lg mb-2" type="text" id="Weight" name="Weight" placeholder="Enter Weight in Kg" />
              <br />
              <label className="font-bold  ml-4" htmlFor="StartTime">
                Start Time :{" "}
              </label>
              <input className="rounded-lg mb-2" type="time" id="StartTime" name="StartTime" placeholder="HH:MM" /> <br />
              <label className="font-bold  ml-4" htmlFor="Duration">
                Duration :{" "}
              </label>
              <input className="rounded-lg mb-2" type="number" id="Duration" name="Duration" placeholder="HH" />
              <input className="rounded-lg mb-2 ml-1" type="number" id="Duration" name="Duration" placeholder="MM" />
              <br />
              <label className="font-bold  ml-4" htmlFor="Calories">
                Calories :{" "}
              </label>
              <input className="rounded-lg mb-2" type="text" id="Calories" name="Calories" placeholder="Calories" /> <br />
