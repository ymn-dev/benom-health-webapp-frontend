...
import cycling01 from "../../assets/cycling01.jpg";
import Benom_Cycling_icon from "../../assets/Benom_Cycling_icon.png";
import fire_icon from "../../assets/3_fire_icon.png";

const Cycling = () => {
  return <>
  <div className=" relative">
    <img src={cycling01} alt="cycling" className=" w-full"/>
    <div className=" absolute top-0 left-0 w-full h-full flex">
      {/* Left */}
      <section className=" w-[50%] h-full bg-white bg-opacity-10">
        <p className="font-bold text-5xl text-white ml-10 mt-20">CYCLING</p>
      </section>
      ...
      <section className=" w-[50%] h-full bg-white bg-opacity-70 p-[5rem] flex flex-col gap-y-[1rem] ">
          ...
          <div className="flex">
              <img src={Benom_Cycling_icon} alt="Benom_Cycling_icon" className="mix-blend-darken w-[6.25rem] h-[6rem]"/>
              <div>
                  ...
                  <select className="select select-bordered border-gray-700 w-40 max-w-xs mb-3">
                    ...
                    <option>TANDEM CYCLING</option>
                    <option>TRACK CYCLING</option>
                    <option>CYCLE SPEEDWAY</option>
                  </select>
              </div> 
          </div>
            <div>
