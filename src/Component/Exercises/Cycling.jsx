...
const Cycling = () => {
  ...
  <div className="flex justify-between bg-[#FF9671]">
    <p className="font-bold text-3xl p-5">CYCLING</p>
  ...
  <div className=" flex ">
    ...
    <div>
      ...
      <div className="flex">
        <img src={Benom_Cycling_icon} alt="Benom_Cycling_icon" />
        <div>
          <img src={fire_icon} alt="fire_icon.png" />
          <details className="dropdown mb-2">
            <summary className="m-2 btn font-bold border-black">CYCLING</summary>
