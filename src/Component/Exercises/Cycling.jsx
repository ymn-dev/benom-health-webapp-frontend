...
const Cycling = () => {
  ...
  return (
    <div className="flex min-h-screen bg-no-repeat bg-cover container mx-auto rounded-2xl " style={{backgroundImage: `url(${CyclingBackground})` 
    ,backgroundSize: "cover"}} >
      <div className="w-2/5 max-lg:hidden" >
        <h2 className="text-7xl m-4 text-white">Cycling</h2></div>
        ...
        <div className=" w-full">
          ...
          <div className="flex  m-3">
            ...
            <h2 className="text-7xl text-white max-lg:hidden">Log Activities</h2>
             ...
             <h3 className="font-bold text-5xl m-4 text-white lg:hidden">Cycling <br />Log Activities</h3>
