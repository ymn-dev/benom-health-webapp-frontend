...
const SignIn = () => {
  ...
  const submitHandler = async (ev) => {
    ...
    try {
      ...
      const { email, joinDate, userName, dailyCalories, height, weight, birthday,profilePicture, gender } = userData.data.data;
      ...
      localStorage.setItem("user", JSON.stringify({ _id,profilePicture, email, joinDate, userName, headers, caloriesBurned, exerciseTime, liveCaloriesBurned, liveExerciseTime, exerciseLog, dailyCalories, height, weight, birthday, gender }));
      setUser({ ...user,profilePicture, _id, email, joinDate, userName, headers, caloriesBurned, exerciseTime, liveCaloriesBurned, liveExerciseTime, exerciseLog, dailyCalories, height, weight, birthday, gender });
