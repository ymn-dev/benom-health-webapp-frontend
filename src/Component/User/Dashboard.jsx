      ...
      <div className="bg-slate-700 flex text-center">
          ...
          <div id="common_activity" className="border-solid border-2 border-white bg-white my-6 ml-6 mr-3 rounded-lg pb-2">
            ...
            <div className="max-w-[200px] w-full mx-auto">
              <div className="flex items-center text-1xl">
                ...
                <a href="#">
                  <img src={plus_button} width={20} height={20} />
                </a>
              </div>
            </div>
        ...
        <div className="flex-1">
          <div className="border-solid border-2 border-white bg-white my-6 ml-3 mr-6 rounded-lg px-2">
            ...
            <div>
              <ul className="flex text-sm">
                <li className="flex w-60 hover:text-xs">
                  <a href="#">Date</a>
                </li>
                <li className="flex-1 hover:text-xs">
                  <a href="#">
                    <img />
                    Activity
                  </a>
            ...
            <br />
            <input type="text" placeholder="End Time" className="input input-bordered input-sm w-3/4 bg-salmon-column text-start mb-2" />
            <button className="btn btn-sm w-1/4 bg-dark-orange text-white rounded-full">Update</button>
          </div>
        </div>
      </div>
    </>
