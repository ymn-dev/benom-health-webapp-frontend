...
const Profile = () => {
  ...
  const [ProfileURL, setProfileURL] = useState(
    "https://i.ibb.co/mHF9LZZ/venom-Cheese.png"
  );
        ...
        <div className="bg-dark-sea   rounded-t-lg ">
          <div className="flex justify-between items-center">
            <div className="relative left-1/2 top-20 transform -translate-x-1/2  lg:left-1/4">
              ...
              <button
                className="absolute bottom-0 right-0 bg-transparent border-none cursor-pointer"
                onClick={() =>
                ...
                <div className="modal-box">
                  ...
                  <div className="field-value-pair mt-5">
                    ...
                    <input
                      ...
                      value={ProfileImg}
                      onChange={(ev) => setProfileImg(ev.target.value)}
                      className="bg-white border border-gray-300 p-5 mb-10 ml-10"
                    />
                  </div>
          ...
          <div className="md:flex-1">
            ...
            <div className="field-value-pair">
              <p className="mb-2 mt-1">
                ...
                <span className="text-dark-sea ml-3">
                  {" "}
                  {user.firstName || "please add via edit button"}
                </span>
              </p>
              <p className="mb-2 mt-1">
                ...
                <span className="text-dark-sea ml-3">
                  {" "}
                  {user.lastName || "please add via edit button"}
                </span>
              </p>
              <p className="mb-2 mt-1">
                <span className="text-black">Gender</span>
                <span className="text-dark-sea ml-8">
                  {" "}
                  {user.gender || "please add via edit button"}
                </span>
              </p>
              <p className="mb-2 mt-1">
                <span className="text-black">Birthday</span>
                <span className="text-dark-sea ml-6">
                  {" "}
                  {user.birthday || "please add via edit button"}
                </span>
              </p>
              <p className="mb-2 mt-1">
              ...
              <p className="mb-2 mt-1">
                ...
                <span className="text-dark-sea ml-8">
                  ...
                  {user.height
                    ? user.height + " (cm)"
                    : "(cm) please add via edit button"}
                </span>
              </p>
              <p className="mb-2 mt-1">
                <span className="text-black">Weight</span>
                <span className="text-dark-sea ml-7">
                  {" "}
                  {user.weight
                    ? user.weight + " (kg)"
                    : "(kg) please add via edit button"}
                </span>
              </p>
            </div>
            ...
            <div className="flex justify-center">
              <Link to="/edit-profile">
                <button className="bg-dark-sea hover:bg-dark-blue text-white font-bold py-2 px-4 rounded block mx-auto  md:mx-0 mt-5 ">
                  Edit
                </button>
              </Link>
              ...
              <button
                ...
                className="bg-dark-sea hover:bg-dark-blue text-white font-bold py-2 px-4 rounded mt-5 ml-5"
              >
                Delete
              </button>
              {/* ส่วน modal  */}
